    ...
    <main className="min-h-screen bg-[#0C0A08]">
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-[#C9822A]/8 blur-3xl pointer-events-none" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left */}
            <div>
              <div className="inline-flex items-center gap-2 bg-[#1A1510] border border-[#2A1F10] rounded-full px-4 py-1.5 mb-6">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <Link
                  href="/calcular"
                  className="flex items-center justify-center gap-2 bg-[#C9822A] hover:bg-[#A86820] text-white font-bold px-7 py-3.5 rounded-xl transition-all shadow-lg shadow-[#C9822A]/25 hover:shadow-[#C9822A]/40 hover:scale-105"
                >
                  <Calculator size={18} />
                ...
                <Link
                  href="/rastreio"
                  className="flex items-center justify-center gap-2 bg-transparent border border-[#C9822A]/40 hover:border-[#C9822A] text-white font-semibold px-7 py-3.5 rounded-xl transition-all"
                >
                  <Package size={18} />
                  Rastrear Pedido
                  <ArrowRight size={16} />
              ...
              <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-5 pt-8 border-t border-[#2A1F10]">
            ...
            <div className="hidden lg:flex items-center justify-center relative h-[420px]">
              <div className="absolute w-96 h-96 rounded-full bg-[#C9822A]/8 blur-3xl" />
              ...
              <div className="relative w-80 h-80">
                ...
                {/* Inner ring */}
                <div className="absolute inset-20 rounded-full border border-[#C9822A]/30 bg-[#C9822A]/5" />
                {/* Center logo */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-[#C9822A] shadow-[0_0_40px_rgba(201,130,42,0.35)]">
                    <Image src="/logo.jpg" alt="Weng Quan" fill className="object-cover" />
                  </div>
                </div>
                {/* Floating icons */}
                <div className="absolute -top-10 -right-6 bg-[#1A1510] border border-[#C9822A]/30 rounded-xl p-2.5 shadow-xl animate-bounce">
                ...
                <div className="absolute -bottom-6 -right-6 bg-[#C9822A] rounded-xl p-2.5 shadow-lg shadow-[#C9822A]/30">
              ...
              {/* Floating stat cards */}
              <div className="absolute top-6 left-0 bg-[#1A1510] border border-[#2A1F10] rounded-xl px-3.5 py-2.5 shadow-2xl">
                <p className="text-[#C9822A] font-black text-xl">+28.500</p>
                <p className="text-gray-500 text-xs">Envios realizados</p>
              </div>
              <div className="absolute bottom-10 right-0 bg-[#1A1510] border border-[#2A1F10] rounded-xl px-3.5 py-2.5 shadow-2xl">
      ...
      <section className="py-10 bg-[#0C0A08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Quick Tracking */}
            <div className="bg-[#141210] border border-[#2A1F10] rounded-2xl p-6 hover:border-[#C9822A]/20 transition-colors">
              ...
              <div className="flex gap-2">
                ...
                <Link
                  href="/rastreio"
                  className="bg-[#C9822A] hover:bg-[#A86820] text-white font-semibold px-5 py-3 rounded-xl transition-all text-sm whitespace-nowrap shadow-md shadow-[#C9822A]/20"
                >
                  Rastrear Agora
                </Link>
              </div>
            ...
            <div className="bg-[#141210] border border-[#2A1F10] rounded-2xl p-6 hover:border-[#C9822A]/20 transition-colors">
              ...
              <Link
                href="/calcular"
                className="w-full flex items-center justify-center gap-2 bg-[#C9822A] hover:bg-[#A86820] text-white font-semibold py-3 rounded-xl transition-all text-sm shadow-md shadow-[#C9822A]/20"
              >
                <Calculator size={15} />
                Calcular Frete
                <ArrowRight size={14} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {features.map((f) => (
              <div
                key={f.title}
                className="bg-[#141210] border border-[#2A1F10] rounded-2xl p-5 hover:border-[#C9822A]/30 transition-all group cursor-default"
              >
                <div className="w-10 h-10 bg-[#C9822A]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#C9822A]/20 transition-all">
      ...
      <section className="py-16 bg-[#141210] border-y border-[#2A1F10]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="w-16 h-16 bg-[#C9822A]/15 border border-[#C9822A]/30 rounded-2xl flex items-center justify-center mx-auto mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/calcular"
              className="inline-flex items-center justify-center gap-2 bg-[#C9822A] hover:bg-[#A86820] text-white font-bold px-8 py-4 rounded-xl transition-all shadow-xl shadow-[#C9822A]/20 hover:scale-105"
            >
              <Calculator size={18} />
              Calcular Frete Agora
              <ArrowRight size={16} />
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#1A1510] border border-[#2A1F10] hover:border-[#C9822A]/30 text-white font-semibold px-8 py-4 rounded-xl transition-all"
            >
              💬 Falar no WhatsApp
            </a>
          </div>
